...
EMBEDDING_MODEL = env('EMBEDDING_MODEL', default='models/text-embedding-004')
EMBEDDING_DIMENSIONS = env('EMBEDDING_DIMENSIONS', default=768, cast=int)
GEMINI_TEXT_MODEL = env('GEMINI_TEXT_MODEL', default='gemini-2.5-flash')
GEMINI_JSON_MODEL = env('GEMINI_JSON_MODEL', default='gemini-1.5-flash')
